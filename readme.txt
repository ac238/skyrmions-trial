...
================================
-run_skyrmionseffective.sh (shell script for temporarily setting environment variables 
                            and executing the application)
   -to run the shell script, type
   
       ./run_skyrmionseffective.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2024a, run the shell script as:
       ...
       ./run_skyrmionseffective.sh /mathworks/home/application/R2024a
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_skyrmionseffective.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure skyrmionseffective.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r skyrmionseffective.zip skyrmionseffective.app
    or the tar command 
    tar -cvf skyrmionseffective.tar skyrmionseffective.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/R2024a/runtime/maci64:MR/R2024a/sys/os/maci64:MR/R2024a/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_skyrmionseffective.sh 
