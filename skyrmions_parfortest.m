...
function time_for = skyrmions_fortest(N)
    ...
    while t<t_final
        ...
        % Coulomb term
        if alpha_val ~= 0
            m_k1=coulomb_parloop(m,dist_x,dist_y,rho);
            m_k2arg = m + dt/2*m_k1;
            m_k2=coulomb_parloop(m_k2arg,dist_x,dist_y,rho);
            m_k3arg = m + dt/2*m_k2;
            m_k3=coulomb_parloop(m_k3arg,dist_x,dist_y,rho);
            m_k4arg = m + dt*m_k3;
            m_k4=coulomb_parloop(m_k4arg,dist_x,dist_y,rho);
